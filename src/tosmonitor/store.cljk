(ns tosmonitor.store
  ...
  This repo archives exactly ONE company (KDDI Corporation, LEI
  5299003FU7V4I45FU310) -- unlike `commitledger.store`'s multi-application
  directory, this Store holds a SINGLE `:company` record and a SINGLE
  `:baseline` record (the latest archived Privacy Policy snapshot this actor
  treats as ground truth to compare candidates against), plus the
...
(def ^:private demo-full-text
  "Privacy Portal\nKDDI Corporation, a Japanese telecommunications carrier, collects and uses personal information from customers and users of its mobile, broadband, and related services in accordance with the Act on the Protection of Personal Information (APPI) and this Privacy Portal's published policies. Collected data is used for service provision, billing, and communications, and is not shared with third parties except as disclosed here or required by law.")

(defn demo-baseline []
  {:full-text    demo-full-text
   :source-url   "https://www.kddi.com/corporate/kddi/public/privacy-portal/"
   :retrieved-at "2026-07-19T07:43:09Z"
