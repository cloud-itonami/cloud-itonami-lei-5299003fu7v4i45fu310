# cloud-itonami-lei-5299003fu7v4i45fu310

> **Independent third-party archive/analysis. Not affiliated with, endorsed by, or sponsored by KDDI株式会社.**

This repository archives the publicly published Privacy Policy of **KDDI株式会社** (KDDI CORPORATION), with
source-url and retrieval-date provenance, per ADR-2607110300 (`cloud-itonami-lei-corporate-tos-catalog`,
`com-junkawasaki/root`). The archive itself (`blueprint.edn`, `NOTICE`, `80-data/public/tos.journal.edn`)
is unchanged by anything below — it stays a read-only reference archive; this repo does not act, propose,
or execute anything on the company's behalf using the archive data itself.
...
[ADR-2607242600](https://github.com/com-junkawasaki/root/blob/main/90-docs/adr/2607242600-cloud-itonami-lei-tos-monitor-actor-batch10-round5.edn),
...
- **Legal name**: KDDI株式会社 (KDDI CORPORATION)
- **LEI (ISO 17442)**: [5299003FU7V4I45FU310](https://search.gleif.org/#/record/5299003FU7V4I45FU310) (GLEIF entity-verified, JP)
- **Jurisdiction**: JP
- **Website**: https://www.kddi.com
- **Ticker**: 9433 (TSE Prime)
- **ISIC Rev.5**: 6110
...
live fetch of the company's current Privacy Policy page and no live `kotoba-server`/CACAO
publish happen anywhere in this actor. `tosmonitor.advisor/llm-advisor` exists as a
written, swappable seam but is not invoked. See
